...
var $author$project$Pages$Top$getSizeOfItem = function (itemIndex) {
	return A2(
		$elm$core$Task$perform,
		function (info) {
			return A2($author$project$Pages$Top$SetHeightOfIndex, itemIndex, info.scene.height);
		},
		A2(
...
var $author$project$Pages$Top$ImageURL = function (a) {
	return {$: 'ImageURL', a: a};
};
...
var $author$project$Pages$Top$buildData = A2(
	...
	_List_fromArray(
		[
			A2(
			$author$project$Pages$Top$Link,
			'https://unsplash.com/photos/PB4VfA6mLek',
			$author$project$Pages$Top$ImageURL('https://images.unsplash.com/photo-1617205058411-52d937f27b75?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80')),
			A2(
			$author$project$Pages$Top$Link,
			'https://dribbble.com/shots/14866937-A-Modern-Jukebox-Stone-Ceramic',
			$author$project$Pages$Top$ImageURL('https://cdn.dribbble.com/users/449429/screenshots/14866937/media/f48dfa50d6fa14c737fa84e114847e4b.jpg?compress=1&resize=400x300')),
			$author$project$Pages$Top$Image(
			$author$project$Pages$Top$ImageURL('https://images.unsplash.com/photo-1617205058411-52d937f27b75?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80')),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text(
												A2($elm$core$Debug$log, '', quoteString))
											]))
									])));
					case 'Link':
						var url = item.a;
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A2($elm$core$List$map, $author$project$Pages$Top$renderTodo, todos.tasks))
								]));
				}
			}());
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Pages$Top$viewColumn(model.data)
					]))
			]),
		title: 'Homepage'
	};
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{
		init: $author$project$Pages$Top$init,
		load: F2(
			function (_v0, model) {
				return _Utils_Tuple2(
					model,
		...
		update: $author$project$Pages$Top$update,
