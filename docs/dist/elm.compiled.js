...
var $author$project$Spa$Generated$Route$SmartmarkInspiration__Top = {$: 'SmartmarkInspiration__Top'};
...
var $author$project$Spa$Generated$Route$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Spa$Generated$Route$SmartmarkInspiration__Top,
...
var $author$project$Spa$Generated$Pages$SmartmarkInspiration__Top__Model = function (a) {
	return {$: 'SmartmarkInspiration__Top__Model', a: a};
};
var $author$project$Spa$Generated$Pages$SmartmarkInspiration__Top__Msg = function (a) {
	return {$: 'SmartmarkInspiration__Top__Msg', a: a};
};
		...
		body: _List_fromArray(
			[
				...
				_List_Nil,
				{
					...
					url: $author$project$Spa$Generated$Route$toString($author$project$Spa$Generated$Route$SmartmarkInspiration__Top)
				})
			]),
		title: '404'
	};
...
var $author$project$Pages$SmartmarkInspiration$Top$SetHeightOfIndex = F2(
	function (a, b) {
		return {$: 'SetHeightOfIndex', a: a, b: b};
	});
...
var $author$project$Pages$SmartmarkInspiration$Top$getSizeOfItem = function (itemIndex) {
	return A2(
		$elm$core$Task$perform,
		function (info) {
			return A2($author$project$Pages$SmartmarkInspiration$Top$SetHeightOfIndex, itemIndex, info.scene.height);
		},
		A2(
				...
				return $elm$core$Task$succeed(
					{
						...
						viewport: {height: -1, width: -1, x: -1, y: -1}
					});
			},
			$elm$browser$Browser$Dom$getViewportOf(
				'item-' + $elm$core$String$fromInt(itemIndex))));
};
var $author$project$Pages$SmartmarkInspiration$Top$RecalulateSize = {$: 'RecalulateSize'};
var $author$project$Pages$SmartmarkInspiration$Top$Image = function (a) {
	return {$: 'Image', a: a};
};
var $author$project$Pages$SmartmarkInspiration$Top$ImageURL = function (a) {
	return {$: 'ImageURL', a: a};
};
...
var $author$project$Pages$SmartmarkInspiration$Top$buildData = A2(
	...
	_List_fromArray(
		[
			A2(
			$author$project$Pages$SmartmarkInspiration$Top$Link,
			'https://unsplash.com/photos/PB4VfA6mLek',
			$author$project$Pages$SmartmarkInspiration$Top$ImageURL('https://images.unsplash.com/photo-1617205058411-52d937f27b75?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80')),
			A2(
			$author$project$Pages$SmartmarkInspiration$Top$Link,
			'https://dribbble.com/shots/14866937-A-Modern-Jukebox-Stone-Ceramic',
			$author$project$Pages$SmartmarkInspiration$Top$ImageURL('https://cdn.dribbble.com/users/449429/screenshots/14866937/media/f48dfa50d6fa14c737fa84e114847e4b.jpg?compress=1&resize=400x300')),
			$author$project$Pages$SmartmarkInspiration$Top$Image(
			$author$project$Pages$SmartmarkInspiration$Top$ImageURL('https://images.unsplash.com/photo-1617205058411-52d937f27b75?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80')),
			...
			$author$project$Pages$SmartmarkInspiration$Top$TodoList(
			{
				tasks: _List_fromArray(
					[
						{done: true, text: 'Complete main workflow wireframes'},
						{done: false, text: 'Design profile dashboard'},
						{done: false, text: 'Upload source files to Dropbox'}
					]),
...
var $author$project$Pages$SmartmarkInspiration$Top$init = F2(
	function (_v0, url) {
		...
		return _Utils_Tuple2(
			{data: data, isTablet: false, url: url},
			A2(
				$elm$core$Task$perform,
				function (_v1) {
		...
		switch (msg.$) {
			...
			case 'ToggleIsTablet':
				return _Utils_Tuple2(
					...
					$author$project$Pages$SmartmarkInspiration$Top$getSizeOfAllItems(model.data));
			case 'RecalulateSize':
				return _Utils_Tuple2(
					model,
					$author$project$Pages$SmartmarkInspiration$Top$getSizeOfAllItems(model.data));
			case 'RecalulateSizeAt':
				var index = msg.a;
				return _Utils_Tuple2(
					model,
			...
			default:
				var item = msg.a;
				var height = msg.b;
				var array = $elm$core$Array$fromList(model.data);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							data: A2(
								...
								A2(
									...
									A2(
										...
										$elm$core$Tuple$mapSecond(
											function (_v1) {
												return A2($elm$core$Basics$min, 200, height);
											}),
...
var $author$project$Pages$SmartmarkInspiration$Top$ToggleIsTablet = {$: 'ToggleIsTablet'};
...
var $author$project$Style$backgroundBlur = function (radius) {
	return _List_fromArray(
		[
...
var $author$project$Style$sticky = $mdgriffith$elm_ui$Element$htmlAttribute(
	$elm$html$Html$Attributes$class('sticky'));
var $author$project$Pages$SmartmarkInspiration$Top$FullWidth = function (a) {
	return {$: 'FullWidth', a: a};
};
...
var $author$project$Colors$colorToRGB = function (color) {
	var rgbColor = $mdgriffith$elm_ui$Element$toRgb(color);
	return 'rgba(' + ($elm$core$String$fromFloat(rgbColor.red * 255) + (',' + ($elm$core$String$fromFloat(rgbColor.green * 255) + (',' + ($elm$core$String$fromFloat(rgbColor.blue * 255) + (',' + ($elm$core$String$fromFloat(rgbColor.alpha) + ')')))))));
};
		...
		_List_fromArray(
			[
				...
				$author$project$Icons$customIconElement(
					{color: $author$project$Colors$white, icon: $feathericons$elm_feather$FeatherIcons$check, size: 12, stroke: 3})) : A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color(
				...
				switch (item.$) {
					...
					case 'Link':
						...
						return A2(
							...
							{description: 'Internet image for url', src: imageUrl});
					case 'Image':
						var imageUrl = item.a.a;
						return A2(
							$mdgriffith$elm_ui$Element$image,
							_List_fromArray(
								[
									...
									A2(
										...
										$author$project$Icons$customIconElement(
											{color: $author$project$Colors$black, icon: $feathericons$elm_feather$FeatherIcons$camera, size: 16, stroke: 1}))),
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									$mdgriffith$elm_ui$Element$height(
									A2(
										$mdgriffith$elm_ui$Element$maximum,
								...
								[
									...
									_List_fromArray(
										[
											...
											$mdgriffith$elm_ui$Element$text(todos.title)),
											A2(
											$mdgriffith$elm_ui$Element$el,
											_List_fromArray(
									...
									A2($elm$core$List$map, $author$project$Pages$SmartmarkInspiration$Top$renderTodo, todos.tasks))
								]));
				}
			}());
	});
var $author$project$Pages$SmartmarkInspiration$Top$viewColumn = function (_v0) {
	var data = _v0.data;
	var isTablet = _v0.isTablet;
	var viewMasonry = function (args) {
		var heights = A2(
			$elm$core$List$map,
			function (_v5) {
				var item = _v5.a;
				var itemHeight = _v5.b;
				if (itemHeight > 0) {
					return itemHeight | 0;
				} else {
					switch (item.$) {
			...
			args.items);
		var dataArray = $elm$core$Array$fromList(args.items);
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$spacing(args.spacing),
					$mdgriffith$elm_ui$Element$padding(args.padding)
				]),
			A2(
				$elm$core$List$map,
							...
							function (_v4) {
								...
								return A2(
									...
									A2(
										$elm$core$Maybe$map,
										function (d) {
											return A3(args.viewItem, position, d, height_);
										},
				...
				$elm$core$List$reverse(
					A2($author$project$Style$Masonry$fromItems, heights, args.columns))));
	};
	var renderItem = F3(
...
var $author$project$Style$zIndex = function (value) {
	return $mdgriffith$elm_ui$Element$htmlAttribute(
		A2(
			$elm$html$Html$Attributes$style,
			'z-index',
			$elm$core$String$fromInt(value + 10)));
};
			...
			[
						...
						[
							...
							A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Background$color(
										A2($author$project$Colors$withAlpha, 0.6, $author$project$Colors$backgroundTop)),
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
										$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
									]),
								$mdgriffith$elm_ui$Element$none)),
							$author$project$Style$sticky,
							$author$project$Style$zIndex(10),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
						]),
					_Utils_ap(
						$author$project$Style$backgroundBlur(10),
				...
				A2(
					...
					$mdgriffith$elm_ui$Element$width(
						A2(
							$mdgriffith$elm_ui$Element$maximum,
							model.isTablet ? 700 : 400,
							$mdgriffith$elm_ui$Element$fill)),
					A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$centerX, $author$project$Style$pagePadding)),
				$author$project$Pages$SmartmarkInspiration$Top$viewColumn(model)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2(
					...
					_List_Nil,
					{
						...
						label: A2(
							...
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Is tablet')),
						onChange: $elm$core$Basics$always($author$project$Pages$SmartmarkInspiration$Top$ToggleIsTablet)
					}))
			]),
		title: 'Homepage'
	};
...
var $author$project$Pages$SmartmarkInspiration$Top$page = $author$project$Spa$Page$application(
	{
		init: $author$project$Pages$SmartmarkInspiration$Top$init,
		load: F2(
			function (_v0, model) {
				return _Utils_Tuple2(
					model,
		...
		update: $author$project$Pages$SmartmarkInspiration$Top$update,
		view: $author$project$Pages$SmartmarkInspiration$Top$view
	});
...
var $author$project$Spa$Generated$Pages$pages = {
	...
	smartmarkInspiration__top: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$SmartmarkInspiration__Top__Model, $author$project$Spa$Generated$Pages$SmartmarkInspiration__Top__Msg, $author$project$Pages$SmartmarkInspiration$Top$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	if (route.$ === 'NotFound') {
		...
		return $author$project$Spa$Generated$Pages$pages.smartmarkInspiration__top.init(_Utils_Tuple0);
	}
};
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	if (bigModel.$ === 'NotFound__Model') {
		var model = bigModel.a;
		return $author$project$Spa$Generated$Pages$pages.notFound.bundle(model);
	} else {
		var model = bigModel.a;
		return $author$project$Spa$Generated$Pages$pages.smartmarkInspiration__top.bundle(model);
	}
};
	...
	function (bigMsg, bigModel) {
		...
		while (true) {
			if (_v0.a.$ === 'NotFound__Msg') {
				...
				if (_v0.b.$ === 'SmartmarkInspiration__Top__Model') {
					var msg = _v0.a.a;
					var model = _v0.b.a;
					return A2($author$project$Spa$Generated$Pages$pages.smartmarkInspiration__top.update, msg, model);
				} else {
					break _v0$2;
				}
			}
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"WindowResized":["Basics.Int","Basics.Int"]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"NotFound__Msg":["Pages.NotFound.Msg"],"SmartmarkInspiration__Top__Msg":["Pages.SmartmarkInspiration.Top.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.SmartmarkInspiration.Top.Msg":{"args":[],"tags":{"NoOp":[],"SetHeightOfIndex":["Basics.Int","Basics.Float"],"RecalulateSize":[],"RecalulateSizeAt":["Basics.Int"],"ToggleIsTablet":[]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}}}}})}});
